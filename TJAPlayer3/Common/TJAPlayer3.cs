...
namespace TJAPlayer3
{
	internal class TJAPlayer3 : Game
	{
		...
		public static readonly string AppInformationalVersion =
			...
			?? $"{GetAppDisplayThreePartVersion()} foooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo";
...
for (int i = 0; i < 3; i++) {
	stage演奏ドラム画面.fDamageLevelFactor[i] = ConfigIni.fDamageLevelFactor[i];
		...
		private void t起動処理()
		{
			...
			#region Discordの処理
			Discord.Initialize("725740474773798994");
